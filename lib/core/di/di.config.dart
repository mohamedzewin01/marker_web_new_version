...
import '../../features/products/presentation/cubit/products_cubit.dart'
    as _i911;
import '../../features/profile/data/data_sources/profile_data_sources_repo.dart'
    as _i301;
import '../../features/profile/data/data_sources/profile_data_sources_repo_impl.dart'
    as _i64;
...
import '../../features/profile/domain/use_cases/profile_use_case_repo_impl.dart'
    as _i1072;
...
import '../uses_cases/profile/profile_use_case_repo.dart' as _i184;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i301.ProfileDataSourcesRepo>(
      () => _i64.ProfileDataSourcesRepoImpl(gh<_i680.ApiService>()),
    );
    ...
    gh.factory<_i364.ProfileRepo>(
      () => _i481.ProfileRepoImpl(gh<_i301.ProfileDataSourcesRepo>()),
    );
    ...
    gh.factory<_i184.ProfileUseCaseRepo>(
      () => _i1072.ProfileUseCaseRepoImpl(gh<_i364.ProfileRepo>()),
    );
    ...
    gh.factory<_i36.ProfileCubit>(
      () => _i36.ProfileCubit(gh<_i184.ProfileUseCaseRepo>()),
    );
