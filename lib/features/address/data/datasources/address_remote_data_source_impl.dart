...
import 'package:fada_alhalij_web/features/address/data/datasources/address_remote_data_source.dart';
...
class AddressRemoteDataSourceImpl implements AddressRemoteDataSource {
  ...
  Future<Result<GetUserAddressEntity?>> getUserAddress() {
    return executeApi(() async{
      ...
      GetUserAddressesRequest getUserAddressRequest = GetUserAddressesRequest(userId: userId);
      var response =await _apiService.fetchAddressesUser(getUserAddressRequest);
